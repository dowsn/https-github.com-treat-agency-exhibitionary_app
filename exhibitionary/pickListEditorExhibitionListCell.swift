//
//  pickListEditorExhibitionListCell.swift
//  Exhibitionary
//
//  Created by Istvan Szilagyi on 31/08/2017.
...
class pickListEditorExhibitionListCell: UITableViewCell {
    ...
    var divider = UIView()
    var thisID:Int = 0
    var parentNewsController:pickListEditorView = pickListEditorView()
